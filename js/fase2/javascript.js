...
function gerar_sujo(){
	var imgs = '<table class="table table-bordered" style="width:20px;">';
	for(linha = 0; linha < linhas; linha++){
		imgs += '<tr>';
		for(coluna = 0; coluna < colunas; coluna++){
			imgs += '<td class="text-center" style="height: 20px;">'+construir_img(linha, coluna, "imgs/sujo.png")+'</td>';
		}
		imgs += '</tr>';
	}
